...
def test_health_check_endpoint():
    ...
    for _ in range(24):  # 24 hours
        ...
        assert response_1.status_code == 200, f"Endpoint {endpoint_1} returned {response_1.status_code} status code."

        response_2 = requests.get(user_url + '\health')
        assert response_2.status_code == 200, f"Endpoint {endpoint_2} returned {response_2.status_code} status code."
